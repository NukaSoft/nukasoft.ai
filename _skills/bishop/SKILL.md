...
## Site Inventory (Last Updated: 2026-05-07 10:40 EDT — auto-generated by medbay)

### Devices

| Name | Type | Model | MAC | IP | Firmware | State |
|------|------|-------|-----|-----|----------|-------|
| **US 24 PoE 250W** | `usw` | US24P250 | `xx:xx:xx:xx:xx:bd` | 192.168.1.69 | 7.4.1.16850 | OFFLINE |
