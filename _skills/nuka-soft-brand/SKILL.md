---
name: nuka-soft-brand
description: Brand guidelines and visual identity system for Nuka-Soft, a retrofuturistic soft drink brand inspired by the Fallout universe aesthetic. Use this skill whenever creating, editing, or referencing Nuka-Soft content — including writing ad copy, taglines, product descriptions, social media posts, presentation materials, character dialogue for Rita Rivera, bottle/packaging design specs, or any creative asset that needs to stay on-brand. Also trigger when the user mentions "Nuka-Soft", "Rita Rivera", "Rita the spokes model", the rocket bottle, or any retrofuturistic beverage branding work. Also use when generating new brand extensions, merchandise concepts, or variant flavors. This skill ensures visual and tonal consistency across all Nuka-Soft outputs.
---
